            ...
            <div className="contact-flex-container">
                ...
                <div className="inside-flex-cont">
                    ...
                    <div className="social-media-handles">
                        <a href="https://www.facebook.com/pruthatek/" target="_blank" rel="noreferrer" > <FaFacebook /> </a>
                        <a href="https://www.instagram.com/pruthatek/" target="_blank" rel="noreferrer" > <FaInstagram className="insta" /></a>
                        <a href="https://in.linkedin.com/company/pruthatek" target="_blank" rel="noreferrer"> <FaLinkedin className="linked-in" /> </a>
                        <a href="https://twitter.com/pruthatek" target="_blank" rel="noreferrer" > <AiFillTwitterCircle style={{ color: "skyblue" }} /> </a>
                    </div>
                </div>
            </div>
        </div>
